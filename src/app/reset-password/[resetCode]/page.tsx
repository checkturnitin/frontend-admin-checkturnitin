...
const ResetPasswordPage = ({ params }: { params: { resetCode: string } }) => {
  ...
  return (
    <main className="min-h-screen bg-indigo-900 flex flex-col items-center justify-center p-4">
      <div className="animate-fade-in-bottom bg-white rounded-xl p-8 max-w-md w-full shadow-lg">
        <h1 className="text-3xl font-bold mb-6 text-indigo-900">Reset Password</h1>
        <p className="mb-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-indigo-900 text-white font-bold py-2 px-4 rounded-md hover:bg-indigo-700 transition-colors duration-300"
          >
            Reset Password
          </button>
        </form>
